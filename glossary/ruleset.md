...
A ruleset is an ordered collection of rule references in Canonic. It represents a domain: a coherent set of behavioral instructions that belong together — Clojure code conventions, blog publishing workflow, vault write rules, agent ergonomics.
